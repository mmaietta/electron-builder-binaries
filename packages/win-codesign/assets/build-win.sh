...
BUILD_DIR="$CWD/.build/osslsigncode-windows"
...
cd "$BUNDLE_DIR"
zip -r -9 "$OUTPUT_DIR/osslsigncode-windows-x64.zip" .

echo ""
echo "✅ Build completed successfully!"
echo "📦 Bundle: $OUTPUT_DIR/osslsigncode-windows-x64.zip"
echo ""
