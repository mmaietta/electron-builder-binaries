const packageMap = {
    ...
    fpm: [
      "fpm-1.16.0-ruby3.3.0-linux-x64.7z",
      "fpm-1.16.0-ruby3.3.0-linux-ia32.7z",
      "fpm-1.16.0-ruby3.3.0-linux-arm64.7z",
      "fpm-1.16.0-ruby3.3.0-linux-arm32.7z",
      "fpm-1.16.0-ruby3.3.0-darwin.7z",
      ],
